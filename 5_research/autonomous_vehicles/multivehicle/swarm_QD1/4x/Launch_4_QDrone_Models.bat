:: Batch Script to be used with the Mission_Server_Swarm_4QDrone.mdl model. 
...
:: These are all the drone IDs X. Set the last digits of your drone IP after the corresponding parameter. 
...
::----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
:: Start a series of Quarc Monitors to be able to monitor all 4 drones and the PC
...
::----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
:: Start a QUARC Console for each of the 4 drones and the PC 
