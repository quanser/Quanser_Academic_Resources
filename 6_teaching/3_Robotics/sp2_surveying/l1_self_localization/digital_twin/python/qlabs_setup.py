...
def setup(
    ...
    hWall.spawn_degrees(location=[1.51, -1.01, 0.1], rotation=[0, 0, 0])
    hWall.set_enable_dynamics(enDynamics)
    hWall.spawn_degrees(location=[-1.51, 1.01, 0.1], rotation=[0, 0, 0])
    hWall.set_enable_dynamics(enDynamics)
    hWall.spawn_degrees(location=[-1.51, 0, 0.1], rotation=[0, 0, 0])
    hWall.set_enable_dynamics(enDynamics)
    hWall.spawn_degrees(location=[-1.51, -1.01, 0.1], rotation=[0, 0, 0])

    # add unique feature to prevent rotational symmetry
    hWall.spawn_degrees(location=[0.88, 1.3, 0.1], rotation=[0, 0, 55])
    hWall.set_enable_dynamics(enDynamics)
    hWall.spawn_degrees(location=[1.22, 0.7, 0.1], rotation=[0, 0, -25])
    hWall.set_enable_dynamics(enDynamics)
    hWall.spawn_degrees(location=[1.3, -0.18, 0.1], rotation=[0, 0, 35])
    hWall.set_enable_dynamics(enDynamics)

    
    hWall.set_enable_dynamics(enDynamics)
    hWall.spawn_degrees(location=[0, 1.51, 0.1], rotation=[0, 0, 90])
    hWall.set_enable_dynamics(enDynamics)
    hWall.spawn_degrees(location=[-1.01, 1.51, 0.1], rotation=[0, 0, 90])
    hWall.set_enable_dynamics(enDynamics)
    hWall.spawn_degrees(location=[1.01, -1.51, 0.1], rotation=[0, 0, 90])
    hWall.set_enable_dynamics(enDynamics)
    hWall.spawn_degrees(location=[0, -1.51, 0.1], rotation=[0, 0, 90])
    ...
    top_camera.spawn_degrees(location=[0.0, 0.0, 4], rotation = [0, 90.0, 90.0])

    top_camera.possess()

    time.sleep(3)
    top_camera.set_camera_properties(90, False, 2.9, 10.0)
