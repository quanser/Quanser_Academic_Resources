...
enDynamics = true
    hWall.spawn_degrees([1.51, -1.01, 0.1], [0, 0, 0]);
    hWall.set_enable_dynamics(true);
    hWall.spawn_degrees([-1.51, 1.01, 0.1], [0, 0, 0]);
    hWall.set_enable_dynamics(true);
    hWall.spawn_degrees([-1.51, 0, 0.1], [0, 0, 0]);
    hWall.set_enable_dynamics(true);
    hWall.spawn_degrees([-1.51, -1.01, 0.1], [0, 0, 0]);
    hWall.set_enable_dynamics(true);

    hWall.spawn_degrees([0.88, 1.3, 0.1], [0, 0, 55]);
    hWall.set_enable_dynamics(true);
    hWall.spawn_degrees([1.22, 0.7, 0.1], [0, 0, -25]);
    hWall.set_enable_dynamics(true);
    hWall.spawn_degrees([1.3, -0.18, 0.1], [0, 0, 35]);
    hWall.set_enable_dynamics(true);

    hWall.spawn_degrees([0, 1.51, 0.1], [0, 0, 90]);
    hWall.set_enable_dynamics(true);
    hWall.spawn_degrees([-1.01, 1.51, 0.1], [0, 0, 90]);
    hWall.set_enable_dynamics(true);
    hWall.spawn_degrees([1.01, -1.51, 0.1], [0, 0, 90]);
    hWall.set_enable_dynamics(true);
    hWall.spawn_degrees([0, -1.51, 0.1], [0, 0, 90]);
...
top_camera.spawn_degrees([0.0, 0.0, 4], [0, 90.0, 90.0], [1,1,1],1)
top_camera.possess()
